...
public class CompassionCommitmentGlobal_Individual extends BaseClass {
	
	@Parameters({"username","password"})
	@Test (groups = {"All","Global_Individual"})
    public void commitment(@Optional("GC_1") String username, @Optional("G33con0404") String password) throws InterruptedException{
	 ...
	 String month="October 2022";
        ...
        System.out.println(">>>>>>>>>>>>>> START - CompassionWebsiteCommitmentGlobal_Individual <<<<<<<<<<<<<<<<<<<<");
        ...
        driver.findElement(surName).sendKeys("Jack");
        driver.findElement(eMail).sendKeys("jackson1234@gmail.com");
        ...
        driver.findElement(continueBtn).click();
    	 ...
    	 System.out.println(">>>>>>>> END - CompassionWebsiteCommitmentGlobal_Individual <<<<<<<<<<<<<<<<<<<<");
